...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default='../outputs/dailydialog/desd', help='saved model dir')

    parser.add_argument('--load_model_state_dir', type=str, default='../outputs/dailydialog/base_model/desd.pkl', help='load model state dir')
